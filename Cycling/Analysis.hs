...
>>> map (normalise_m (0,10)) [Just 5,Nothing]
[Just 0.5,Nothing]
-}
...
>>> normalise_r_m [Just 0,Nothing,Just 10]
[Just 0.0,Nothing,Just 1.0]
-}
...
>>> zipMaybe [1..] [Just 'a',Nothing,Just 'c']
[(1,'a'),(3,'c')]
-}
...
>>> extractor (>=) fst snd 4 (zip "abdc" [5,3,3,4])
[('a',5),('c',4)]
-}
