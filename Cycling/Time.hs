...
>>> format_duration (parse_duration "21:44:30")
"21:44:30"
-}
...
>>> toGregorian (utctDay (add_days 1 (T.parse_iso8601_date "2011-10-09")))
(2011,10,10)
-}
...
>>> toGregorian (utctDay (add_months 1 (T.parse_iso8601_date "2011-10-09")))
(2011,11,9)
-}
