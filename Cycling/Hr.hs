...
>>> map (round . hr_max_haskell_and_fox) [36,40,49]
[184,180,171]
-}
...
>>> map (round . hr_max_robergs_and_landwehr) [36,40,49]
[181,178,172]
-}
...
>>> map (round . hr_max_londeree_and_moeschberger) [36,40,49]
[181,178,171]
-}
...
>>> map (round . hr_max_miller_et_al) [36,40,49]
[186,183,175]
-}
...
>>> map (round . hr_max_tanaka) [36,40,49]
[183,180,174]
-}
...
>>> map (round . hr_max_oakland_nonlinear) [36,40,49]
[182,180,175]
-}
...
>>> map (round . hr_max_lund) [36,40,49]
[184,182,175]
-}
hr_max_lund :: Hr_Max
...
>>> let n = 36
>>> map (\f -> round (f n)) hr_max_all
[184,181,181,186,183,182,184]
-}
hr_max_all :: [Hr_Max]
hr_max_all =
...
>>> map zone_round (hr_zones_garmin 184)
[(92,110),(111,128),(129,147),(148,165),(166,184)]
-}
...
> map zone_round (hr_zones_ctips 184)
[(92,119),(120,132),(135,147),(155,165),(168,184)]
-}
...
>>> hr_zones_zoladz 184
[(129,139),(139,149),(149,159),(159,169),(169,179)]
-}
...
>>> map zone_round (hr_zones_jf 167)
[(126,135),(136,148),(149,156),(157,165),(167,170),(173,177),(178,208)]
-}
...
>>> zones_bounded_hrm' 185 hr_zones_wb
[(0,111),(111,120),(121,138),(139,151),(152,164),(165,173),(174,185),(185,370)]
-}
hr_zones_wb :: Num n => [n]
...
>>> Data.Maybe.mapMaybe (hr_lookup_wb 185) [130,135 .. 185]
[(130.0,2,"2.Basic"),(135.0,2,"2.Basic"),(140.0,3,"3.Intensive"),(145.0,3,"3.Intensive"),(150.0,3,"3.Intensive"),(155.0,4,"4.Intensive"),(160.0,4,"4.Intensive"),(165.0,5,"5.Maximal"),(170.0,5,"5.Maximal"),(175.0,6,"6.Maximal"),(180.0,6,"6.Maximal"),(185.0,7,"7.Supramaximal")]
-}
...
>>> let hr = 167
>>> map (\x -> round (x * 0.01 * hr)) (Data.Maybe.mapMaybe snd hr_gcn)
[114,139,157,175]
-}
